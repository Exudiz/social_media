...
// Fetch following
$sql_following = "SELECT users.id, users.username FROM users
                INNER JOIN followers ON users.id = followers.followee_id
        ...
        <?php if (!empty($following)) { ?>
            <ul>
                <?php foreach ($following as $follow) { ?>
                    <li><a href="profile.php?user_id=<?php echo $follow['id']; ?>"><?php echo $follow['username']; ?></a></li>
                <?php } ?>
            </ul>
        <?php } else { ?>
